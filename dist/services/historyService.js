...
function isValidHistoryEntry(entry) {
    if (typeof entry !== "object" || entry === null)
        return false;
    const e = entry;
    return (typeof e.searchedAt === "string" &&
        typeof e.pokemon === "object" &&
        e.pokemon !== null &&
        typeof e.pokemon.name === "string" &&
        typeof e.pokemon.displayId === "string");
}
...
export function addToHistory(pokemon) {
    const existingIndex = history.findIndex((entry) => entry.pokemon.displayId === pokemon.displayId);
    if (existingIndex !== -1) {
